    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playLoggedIn = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (delete) {
                    ...
                    /*
                    int id_to_pass = ((Button) view).getId();
                    String name_to_pass = String.valueOf(((Button) view).getText());
        ...
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                userModel[1] = dataBaseHelper.getOneById(users_to_pass[1]);

                Intent i = new Intent(SignUp.this, MainActivity.class);
                i.putExtra("user_1_id", users_to_pass[0]);
                i.putExtra("user_1_name", userModel[0].getName());
                i.putExtra("user_2_id", users_to_pass[1]);
                i.putExtra("user_2_name", userModel[1].getName());
                startActivity(i);
            }
        });
